...
def get_args_parser():
    ...
    parser.add_argument('--data_path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--nb_classes', default=539, type=int,
    ...
    parser.add_argument('--use_custom_patch', default=0, type=int)
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        #print(f"Accuracy of the network on the {len(dataset_val)} test images: {test_stats['acc1']:.1f}%")
        """
        max_accuracy = min(max_accuracy, test_stats["acc1"])
        print(f'Min Loss: {max_accuracy:.2f}%')
        """
